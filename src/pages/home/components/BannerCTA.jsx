...
function BannerCTA() {
  return (
    <section
      style={{
        backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.8), rgba(0, 0, 0, 0.8)), url("asset/bannerCTA/BannerCTA.jpg")`,
      }}
      className="bg-cover bg-center bg-no-repeat rounded-[10px]"
    >
      <form
        action=""
        className="subscribe flex flex-col justify-center items-center gap-10 min-h-100 py-17 px-5 lg:py-23 lg:px-[337.5px]"
      >
        ...
        <div className="subscribe-btn rounded-[0.625rem] flex w-full flex-col gap-4 items-center lg:flex-row lg:bg-primaryBg lg:gap-5 lg:py-2 lg:pr-2 lg:pl-5">
          <Label htmlFor="subsEmail" className="hidden">
            E-Mail
          </Label>
          <Input
            id="SubsEmail"
